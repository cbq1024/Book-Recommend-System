...
export default defineConfig({
    // base: "/book-recommend/",
    title: "book-recommend docs",
    description: "A docs for book-recommend create by cbq1024",
    markdown: {
        math: true,
        lineNumbers: true
    },
    ...
    themeConfig: {
        head: [["link", {rel: "icon", href: "/book-recommend/mcdd.jpg"}]],
        outline: [2, 4],
        lastUpdated: true,
        ...
        nav: [
            {text: 'Home', link: '/'},
            {
                text: '🤯 项目文档',
                items: [
                    {text: '🤪 01-项目申请书', link: '/start/start-01.md'},
